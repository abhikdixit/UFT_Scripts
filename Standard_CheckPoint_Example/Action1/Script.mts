...
WpfWindow("HPE MyFlight Sample Applicatio").WpfButton("SELECT FLIGHT").Check CheckPoint("SELECT FLIGHT") @@ hightlight id_;_2002654056_;_script infofile_;_ZIP::ssf1.xml_;_
...
WpfWindow("HPE MyFlight Sample Applicatio").WpfButton("SELECT FLIGHT").Check CheckPoint("SELECT FLIGHT_2") @@ hightlight id_;_2002653576_;_script infofile_;_ZIP::ssf3.xml_;_
