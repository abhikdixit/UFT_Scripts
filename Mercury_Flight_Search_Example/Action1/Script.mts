SystemUtil.Run "firefox.exe", "http://newtours.demoaut.com/mercurywelcome.php" 'opens Mercury Tours in Internet Explorer browser
...
Browser("Select a Flight: Mercury").Page("Select a Flight: Mercury").WebRadioGroup("outFlight").Select 1 @@ script infofile_;_ZIP::ssf9.xml_;_
